    ...
    <body>		
		<div id="top-bar" class="container">
			<div class="row">
				...
				<span class="navbar-inner main-menu"><a href="index.php" class="logo pull-left"><img src="assets/themes-front/images/mr_head.png" class="site_logo" alt=""></a></span></div>
				<div class="span8">
		...
		<section  class="homepage-slider" id="home-slider">
				<div class="flexslider">
					...
					<ul class="slides">
						...
						<li>
							<img src="upload/banner/bannerps1.png" alt="" />
							
						</li>
						<li>
							<img src="upload/banner/bannerps2.png" alt="" />
						</li>
					</ul>
				</div>			
		</section> 
